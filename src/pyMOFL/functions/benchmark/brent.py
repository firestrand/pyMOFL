...
@register("brent")
class BrentFunction(OptimizationFunction):
    """
    Brent function (2D).

    f(x) = (x1 + 10)^2 + (x2 + 10)^2 + exp(-x1^2 - x2^2)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if dimension != 2:
            raise ValueError("Brent function requires dimension=2")
