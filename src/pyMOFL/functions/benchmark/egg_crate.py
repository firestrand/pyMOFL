"""Egg Crate function implementation."""
...
@register("egg_crate")
class EggCrateFunction(OptimizationFunction):
    """
    Egg Crate function (2D).

    f(x) = x1^2 + x2^2 + 25*(sin(x1)^2 + sin(x2)^2)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if dimension != 2:
            raise ValueError("Egg Crate function requires dimension=2")
