"""
Validation tests for CEC 2022 benchmark suite against golden datasets.
"""
...
SUITE_JSON = "src/pyMOFL/constants/cec/2022/cec2022_suite.json"
DATA_DIR = "src/pyMOFL/constants/cec/2022"
...
# SchafferF7 in hybrids uses stale global y[] in CEC C reference (dead rotation bug)
XFAIL_FUNCS = {
    7: "Hybrid F7 (hf10) contains SchafferF7 which uses stale global y[] in CEC C reference",
}


class TestCEC2022Validation:
    """Test all CEC 2022 functions against golden data."""

    @pytest.mark.parametrize("func_id", list(range(1, 13)))
    ...
    def test_function(self, factory, suite_config, func_id, dim):
        ...
        cases = load_golden_cases("CEC2022", func_id, dim, GOLDEN_ROOT)
        if not cases:
...
class TestCEC2022Construction:
    """Test that all CEC 2022 functions can be constructed."""
