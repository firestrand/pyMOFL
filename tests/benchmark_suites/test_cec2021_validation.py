"""
Validation tests for CEC 2021 benchmark suite against golden datasets.
"""
...
SUITE_JSON = "src/pyMOFL/constants/cec/2021/cec2021_suite.json"
DATA_DIR = "src/pyMOFL/constants/cec/2021"
...
class TestCEC2021Validation:
    """Test all CEC 2021 functions against golden data."""
    ...
    def test_function(self, factory, suite_config, func_id, dim):
        ...
        cases = load_golden_cases("CEC2021", func_id, dim, GOLDEN_ROOT)
        if not cases:
...
class TestCEC2021Construction:
    """Test that all CEC 2021 functions can be constructed."""
