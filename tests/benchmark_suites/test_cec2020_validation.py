"""
Validation tests for CEC 2020 benchmark suite against golden datasets.
"""
...
SUITE_JSON = "src/pyMOFL/constants/cec/2020/cec2020_suite.json"
DATA_DIR = "src/pyMOFL/constants/cec/2020"
...
class TestCEC2020Validation:
    """Test all CEC 2020 functions against golden data."""
    ...
    def test_function(self, factory, suite_config, func_id, dim):
        ...
        cases = load_golden_cases("CEC2020", func_id, dim, GOLDEN_ROOT)
        if not cases:
...
class TestCEC2020Construction:
    """Test that all CEC 2020 functions can be constructed."""

    @pytest.mark.parametrize("func_id", list(range(1, 11)))
    def test_construct(self, factory, suite_config, func_id):
        # Use dim=10 since all functions support it
