...
from pyMOFL.functions import StepFunction
...
class TestStepFunction:
    ...
    def test_evaluate_batch(self):
        ...
        # Test (simulate bias since wrapper is commented)
        results = func.evaluate_batch(batch) + bias_value
